...
///
/// No public constructor: only [NativeCalls#checkError(java.lang.foreign.MemorySegment)] constructs
/// one, from the C string `errptr` reports. This type is never used to wrap an `invokeExact`
/// failure — see [NativeCalls#wrapInvokeFailure(String, Throwable)] and
